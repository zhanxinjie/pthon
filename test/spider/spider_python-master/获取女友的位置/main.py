...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "14495d310f700a49a21fdd2585640929"
    ...
    def __format_lati_long_data(self, data):
        ...
        print(f'{data_list_tmp},{data_list},{data_tmp}')
        ...
        print(f'{data_sec},{data_tmp},{data_minute},{data_degree}')
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            ...
            print(f'{latitude_gps},{latitude_direction},{longitude_gps},{longitude_direction},{take_time}')
...
if __name__ == '__main__':
    # 女朋友发过来的图片【原图】
    location = Location('./picture/b68b15ad88d13a322db63b6a971ed41.jpg')
    # 找到女朋友的地理位置
    location.run()
