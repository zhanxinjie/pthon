...
def export(host,user,password,dbname,table_name,outputpath):
    ...
    sheet = workbook.add_sheet('reach_'+table_name,cell_overwrite_ok=True)
...
#     workbook.save(outputpath)
    global filename 
    filename = outputpath + time.strftime('%Y%m%d%H%M') + ".xlsx"  
    ...
    #定位到sheet1
    worksheet1 = workbook.sheet_by_name(u'reach_user')
    print(worksheet1)
...
if __name__ == "__main__":
    export('localhost','root','111111','reach','user',r'datetest_')
